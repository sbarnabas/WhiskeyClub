...
angular.module("template/rating/rating.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rating/rating.html",
    ...
    "	<i ng-repeat=\"number in range\" ng-mouseenter=\"enter(number)\" ng-click=\"rate(number)\" ng-class=\"{'icon-2x':true,'icon-circle': number <= val, 'icon-circle-blank': number > val}\"></i>\n" +
    "</span>\n" +
    "");
}]);
